...
public class UserRouter {
    ...
    public ResponseEntity getMyProjectList(@PathVariable String layer, @PathVariable String sess_workspace_id, HttpServletRequest httpServletRequest, @RequestBody WorkspaceReqDto workspaceReqDto){
        workspaceReqDto.setSess_layer(SessionLayerTypes.getLayerType(layer));
